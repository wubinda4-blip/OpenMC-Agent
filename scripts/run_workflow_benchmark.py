...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--enable-semantic-audit", dest="enable_semantic_audit", action="store_true", default=True)
    parser.add_argument("--disable-semantic-audit", dest="enable_semantic_audit", action="store_false")
    ...
    parser.add_argument("--enable-llm-repair", dest="enable_llm_repair", action="store_true", default=True)
    parser.add_argument("--disable-llm-repair", dest="enable_llm_repair", action="store_false")
    ...
    parser.add_argument("--enable-run-supervisor", dest="enable_run_supervisor", action="store_true", default=True)
    parser.add_argument("--disable-run-supervisor", dest="enable_run_supervisor", action="store_false")
