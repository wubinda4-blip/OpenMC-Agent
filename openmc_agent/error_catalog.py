...
ERROR_CATALOG: dict[str, CatalogEntry] = {
    ...
    "runtime.source_strategy_not_rendered": {
        "severity": "error",
        "message": "the declared source_strategy was not honoured by the renderer; bounds were derived from a different strategy",
        "schema_path": "complex_model.settings.source_strategy",
        "rule_id": "rule.runtime.source_strategy_render_mismatch",
        "concept_id": "openmc.settings.source",
        "knowledge_refs": [OPENMC_RUNTIME_GUIDE],
        "grep_patterns": ["source_strategy", "IndependentSource"],
        "route_hint": "auto_repair",
        "repair_hints": [
            _hint("edit_field", "Ensure the renderer uses the declared source_strategy to derive source bounds.",
                  target_path="complex_model.settings.source_strategy"),
        ],
    },
    "runtime.source_bounds_render_mismatch": {
        "severity": "error",
        "message": "rendered source bounds do not match the declared source strategy bounds",
        "schema_path": "settings.source",
        "rule_id": "rule.runtime.source_bounds_mismatch",
        "concept_id": "openmc.settings.source",
        "knowledge_refs": [OPENMC_RUNTIME_GUIDE],
        "grep_patterns": ["Box", "source"],
        "route_hint": "auto_repair",
        "repair_hints": [
            _hint("edit_field", "Ensure the renderer uses source_bounds_for_plan with the correct strategy.",
                  target_path="settings.source"),
        ],
    },
    "runtime.manual_source_bounds_missing": {
        "severity": "error",
        "message": "source_strategy='manual' but manual_source_bounds_cm is not set",
        "schema_path": "complex_model.settings.manual_source_bounds_cm",
        "rule_id": "rule.runtime.manual_source_missing",
        "concept_id": "openmc.settings.source",
        "knowledge_refs": [OPENMC_RUNTIME_GUIDE],
    ...
    "runtime.unknown_source_strategy": {
        "severity": "error",
        "message": "source_strategy is 'unknown'; cannot derive source bounds",
        "schema_path": "complex_model.settings.source_strategy",
        "rule_id": "rule.runtime.unknown_source_strategy",
        "concept_id": "openmc.settings.source",
        "knowledge_refs": [OPENMC_RUNTIME_GUIDE],
    ...
    "runtime.source_repair_no_xml_change": {
        "severity": "error",
        "message": "source repair was committed but settings.xml source box did not change",
        "schema_path": "settings.source",
        "rule_id": "rule.runtime.source_repair_noop",
        "concept_id": "openmc.settings.source",
        "knowledge_refs": [OPENMC_RUNTIME_GUIDE],
