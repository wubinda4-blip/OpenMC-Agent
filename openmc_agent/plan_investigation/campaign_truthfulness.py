...
# Phase 8C Step 0 — Facts neutral context + truth audit violations.
TV_FACTS_DEFAULT_SCOPE_CONTAMINATION = (
    "facts_default_scope_contamination"
)
TV_FACTS_DEFAULT_VALUE_RENDERED_AS_AUTHORITATIVE = (
    "facts_default_value_rendered_as_authoritative"
)
TV_FACTS_UNKNOWN_CONTEXT_RENDERED = (
    "facts_unknown_context_rendered"
)
TV_FACTS_INVESTIGATION_COMPLETED_WITHOUT_MANDATORY_COVERAGE = (
    "facts_investigation_completed_without_mandatory_coverage"
)
TV_FACTS_MANDATORY_TARGET_DROPPED = (
    "facts_mandatory_target_dropped"
)
TV_FACTS_CONTRACT_MISSING = "facts_contract_missing"
TV_FACTS_CONTRACT_HASH_MISMATCH = "facts_contract_hash_mismatch"
TV_FACTS_LOCKED_SLOT_MODIFIED = "facts_locked_slot_modified"
TV_FACTS_REQUIRED_SLOT_DROPPED = "facts_required_slot_dropped"
TV_FACTS_FUEL_VARIANT_DROPPED = "facts_fuel_variant_dropped"
TV_FACTS_LOCALIZED_INSERT_DROPPED = "facts_localized_insert_dropped"
TV_FACTS_SCOPE_DOWNGRADED = "facts_scope_downgraded"
TV_FACTS_FEATURE_FLAG_DISABLED = "facts_feature_flag_disabled"
TV_FACTS_UNRESOLVED_VALUE_FABRICATED = "facts_unresolved_value_fabricated"
TV_FACTS_CONFLICT_SILENTLY_RESOLVED = "facts_conflict_silently_resolved"
TV_FACTS_RETRY_REGISTERED_BUT_NOT_EXECUTED = (
    "facts_retry_registered_but_not_executed"
)
TV_FACTS_SPECIAL_ROUTE_NOT_EXECUTED = "facts_special_route_not_executed"
TV_FACTS_CANDIDATE_VALIDATED_ON_LIVE_STATE = (
    "facts_candidate_validated_on_live_state"
)
TV_FACTS_COMMIT_WITHOUT_REVIEWER_REPLAY = (
    "facts_commit_without_reviewer_replay"
)
TV_FACTS_GATE_REOPENED_WITHOUT_HASH_CHANGE = (
    "facts_gate_reopened_without_hash_change"
)
TV_FACTS_REVIEWER_OUTPUT_REUSED = "facts_reviewer_output_reused"
TV_FACTS_DOWNSTREAM_CONTRACT_NOT_RECOMPILED = (
    "facts_downstream_contract_not_recompiled"
)
TV_FACTS_NO_PROGRESS_LOOP_CONTINUED = "facts_no_progress_loop_continued"
TV_FACTS_REAL_CANARY_CLAIM_WITHOUT_ACCEPTANCE = (
...
INVESTIGATION_TRUTH_VIOLATIONS: tuple[str, ...] = (
    ...
    TV_RESEARCH_SOURCE_ABSENCE_DEFAULTED,
    TV_FRAGMENT_CACHE_REUSED_ACROSS_REQUIREMENT_HASH_CHANGE,
    # Phase 8C Step 0 additions — Facts neutral context + audit.
    TV_FACTS_DEFAULT_SCOPE_CONTAMINATION,
    TV_FACTS_DEFAULT_VALUE_RENDERED_AS_AUTHORITATIVE,
    TV_FACTS_UNKNOWN_CONTEXT_RENDERED,
    TV_FACTS_INVESTIGATION_COMPLETED_WITHOUT_MANDATORY_COVERAGE,
    TV_FACTS_MANDATORY_TARGET_DROPPED,
    TV_FACTS_CONTRACT_MISSING,
    TV_FACTS_CONTRACT_HASH_MISMATCH,
    TV_FACTS_LOCKED_SLOT_MODIFIED,
    TV_FACTS_REQUIRED_SLOT_DROPPED,
    TV_FACTS_FUEL_VARIANT_DROPPED,
    TV_FACTS_LOCALIZED_INSERT_DROPPED,
    TV_FACTS_SCOPE_DOWNGRADED,
    TV_FACTS_FEATURE_FLAG_DISABLED,
    TV_FACTS_UNRESOLVED_VALUE_FABRICATED,
    TV_FACTS_CONFLICT_SILENTLY_RESOLVED,
    TV_FACTS_RETRY_REGISTERED_BUT_NOT_EXECUTED,
    TV_FACTS_SPECIAL_ROUTE_NOT_EXECUTED,
    TV_FACTS_CANDIDATE_VALIDATED_ON_LIVE_STATE,
    TV_FACTS_COMMIT_WITHOUT_REVIEWER_REPLAY,
    TV_FACTS_GATE_REOPENED_WITHOUT_HASH_CHANGE,
    TV_FACTS_REVIEWER_OUTPUT_REUSED,
    TV_FACTS_DOWNSTREAM_CONTRACT_NOT_RECOMPILED,
    TV_FACTS_NO_PROGRESS_LOOP_CONTINUED,
    TV_FACTS_REAL_CANARY_CLAIM_WITHOUT_ACCEPTANCE,
)
