...
TraceEventType = Literal[
    ...
    "run_supervisor_decision_proposed",
    "run_supervisor_decision_accepted",
    "run_supervisor_decision_vetoed",
    "run_supervisor_fallback_used",
    "run_supervisor_action_executed",
    "run_supervisor_no_progress",
    "run_supervisor_loop_detected",
    "run_supervisor_budget_exhausted",
    ...
    "runtime_repair_ownership_resolved",
    "runtime_deterministic_repair_started",
    ...
    "runtime_repair_committed",
    "runtime_reexecution_scheduled",
    "runtime_repair_no_progress",
    "runtime_repair_duplicate_candidate",
    "runtime_repair_budget_exhausted",
    "runtime_llm_diagnosis_started",
    "runtime_llm_diagnosis_completed",
    "runtime_llm_diagnosis_invalid",
    "runtime_llm_diagnosis_no_safe_repair",
    "runtime_llm_diagnosis_validated",
    "runtime_llm_proposal_started",
    "runtime_llm_proposal_generated",
    "runtime_llm_proposal_invalid",
    "runtime_llm_proposal_rejected",
    "runtime_llm_proposal_accepted",
    "runtime_llm_client_unavailable",
    "runtime_llm_schema_correction_attempted",
    "runtime_llm_repair_committed",
    "runtime_llm_reexecution_scheduled",
    "runtime_llm_repair_no_progress",
    "runtime_llm_repair_budget_exhausted",
    "runtime_iteration_started",
    "runtime_iteration_completed",
    "runtime_supervisor_started",
    "runtime_supervisor_decision_proposed",
    "runtime_supervisor_decision_vetoed",
    "runtime_supervisor_decision_accepted",
    "runtime_supervisor_deterministic_fallback",
    "runtime_supervisor_client_unavailable",
    "runtime_reexecution_prepared",
    "runtime_reexecution_started",
    "runtime_reexecution_completed",
    "runtime_transient_retry_scheduled",
    "runtime_transient_retry_exhausted",
    "runtime_failure_changed",
    "runtime_same_failure_recurred",
    "runtime_progress_detected",
    "runtime_no_progress_detected",
    "runtime_loop_detected",
    "runtime_budget_exhausted",
    "runtime_recovery_succeeded",
    "runtime_recovery_stopped",
    "workflow_completed",
    "workflow_failed",
]
