"""Generated OpenMC pin-cell model for uo2_pin_cell_criticality."""
...
material_0.add_nuclide('U235', 3.1, 'ao')
material_0.add_nuclide('U238', 96.9, 'ao')
...
material_2.add_element('Sn', 1.23, 'wo')
material_2.add_element('Fe', 0.19, 'wo')
