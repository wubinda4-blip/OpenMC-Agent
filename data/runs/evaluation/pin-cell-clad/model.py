"""Generated OpenMC pin-cell model for uo2_zr_pin_cell_criticality."""
...
material_0.add_nuclide('U235', 1.6667, 'ao')
material_0.add_nuclide('U238', 31.6667, 'ao')
material_0.add_nuclide('O16', 66.6666, 'ao')

material_1 = openmc.Material(name='light_water')
material_1.set_density('g/cm3', 0.997)
material_1.add_nuclide('H1', 66.6667, 'ao')
material_1.add_nuclide('O16', 33.3333, 'ao')
...
material_2.add_element('Ni', 0.01, 'wo')
