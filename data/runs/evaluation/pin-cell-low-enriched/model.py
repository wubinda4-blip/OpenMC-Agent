"""Generated OpenMC pin-cell model for low_enriched_uo2_pincell."""

import openmc


material_0 = openmc.Material(name='uo2_fuel_3p5')
material_0.set_density('g/cm3', 10.0)
material_0.add_nuclide('U235', 0.035, 'ao')
material_0.add_nuclide('U238', 0.965, 'ao')
material_0.add_nuclide('O16', 2.0, 'ao')

material_1 = openmc.Material(name='light_water')
material_1.set_density('g/cm3', 0.7)
...
material_2.add_element('Zr', 0.9823, 'wo')
material_2.add_element('Sn', 0.0145, 'wo')
material_2.add_element('Fe', 0.0021, 'wo')
material_2.add_element('Cr', 0.0011, 'wo')
